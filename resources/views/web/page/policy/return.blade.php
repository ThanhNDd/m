...
@section('content')
  <div id="app">
    ...
    <div class="body-content outer-top-xs">
      <div class="container">
        <div class="col-md-12 col-sm-12 col-xs-12 padding-8" style="padding: 8px; float: left; width: 710px; color: rgb(51, 51, 51); font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 14px;">
          <h1 style="text-align: center; box-sizing: border-box; margin: 20px 0px 10px; font-size: 28px; font-family: inherit; font-weight: 500; line-height: 36px; color: inherit;"><strong style="box-sizing: border-box; font-weight: bold;"><span style="font-family: Tahoma;">Chính sách đổi trả hàng</span></strong></h1>
          <h1 style="text-align: center; margin: 20px 0px 10px; font-size: 28px; line-height: 36px;">
            <div class="col-md-12 col-sm-12 col-xs-12 padding-8" style="padding: 8px; float: left; width: 710px; font-size: 14px; text-align: start;"><span style="font-family: Tahoma;">Với mong muốn mang lại sự hài lòng cho quý khách khi mua hàng trực tuyến tại <b>Shop Mẹ Ỉn</b>, chúng tôi có những quy định trong trường hợp quý khách muốn đổi hàng; nhằm đảm bảo rằng những sản phẩm quý khách mua là sản phẩm mà vừa ý nhất.</span></div>
            <div class="col-md-12 col-sm-12 col-xs-12 nopadding" style="float: left; width: 710px; font-size: 14px; text-align: start; padding: 0px !important; margin: 0px !important;">
