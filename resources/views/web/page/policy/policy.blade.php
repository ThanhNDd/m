<div class="policy-info">
    <div class="policy no-mobile" style="width: 50%">
        ...
        <span>
                    <i class="fa fa-arrow-circle-right text-success"></i> Cước phí vận chuyển trong Hà nội là <b
                    class="text-danger">20K</b>, tỉnh thành khác từ <b class="text-danger">30K</b>.
                  </span>
        <span>
                    <i class="fa fa-arrow-circle-right text-success"></i>
                    <b class="text-danger">FREESHIP</b> Hà nội cho đơn hàng từ
                    <b class="text-danger">250K</b>
                  </span>
        <span>
                    <i class="fa fa-arrow-circle-right text-success"></i>
