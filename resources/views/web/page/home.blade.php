                                        ...
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image">
                                                        <a href="detail.html">
                                                            <img src="{{url('resources/views/web/assets/images/products/p4.jpg') }}" alt="">
                                                            <img src="{{url('resources/views/web/assets/images/products/p4_hover.jpg') }}" alt="" class="hover-image">
                                                        </a>
                                                    </div>
                                                    <!-- /.image -->
                                        ...
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image">
                                                        <a href="detail.html">
                                                            <img src="{{url('resources/views/web/assets/images/products/p6.jpg') }}" alt="">
                                                            <img src="{{url('resources/views/web/assets/images/products/p6_hover.jpg') }}" alt="" class="hover-image">
                                                        </a>
                                                    </div>
                                                    <!-- /.image -->
                                        ...
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image">
                                                        <a href="detail.html">
                                                            <img src="{{url('resources/views/web/assets/images/products/p5.jpg') }}" alt="">
                                                            <img src="{{url('resources/views/web/assets/images/products/p5_hover.jpg') }}" alt="" class="hover-image">
                                                        </a>
                                                    </div>
                                                    <!-- /.image -->
                                        ...
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image">
                                                        <a href="detail.html">
                                                            <img src="{{url('resources/views/web/assets/images/products/p12.jpg') }}" alt="">
                                                            <img src="{{url('resources/views/web/assets/images/products/p12_hover.jpg') }}" alt="" class="hover-image">
                                                        </a>
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="image">
                                                    <a href="detail.html">
                                                        <img src="{{url('resources/views/web/assets/images/products/p14.jpg') }}" alt="">
                                                        <img src="{{url('resources/views/web/assets/images/products/p14_hover.jpg') }}" alt="" class="hover-image">
                                                    </a>
