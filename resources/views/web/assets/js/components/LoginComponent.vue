  ...
  <div>
    ...
    <div v-else class="dropdown dropdown-cart show">
      ...
      <a
        ...
        class="dropdown-toggle customer-logged"
        aria-expanded="true"
      >
        &nbsp;{{ customer_name }}
      </a>
    ...
    <div class="modal fade" id="loginForm" tabindex="-1" role="dialog">
      <div
        v-bind:class="[
          'modal-dialog',
          isRegister && isVerifySMSCodeSuccess ? 'modal-lg' : '',
        ]"
        role="document"
      >
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            <h5 class="modal-title" v-if="isSendEmailVerifyCode">
          ...
          <div class="modal-body col-md-12">
            ...
            <div v-if="isLogin">
              <div
                class="page-content"
                style="background: #fff; padding-bottom: 20px"
              >
                  ...
                  >
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="[
                          'form-control',
                          !is_valid_phone || !is_valid_phone_format
                            ? 'form-control--error'
                            : '',
                        ]"
                        v-model="phone"
                      ...
                      />
                      <p
                        class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                        v-if="!is_valid_phone"
                      >
                      ...
                      <p
                        class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                        v-if="!is_valid_phone_format"
                      >
                        Số điện thoại không đúng
                      </p>
                      <p
                        class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                        v-if="is_valid_phone_not_exist"
                      >
                        Số điện thoại không tồn tại. Bạn có thể
                        <a
                          href="javascript:void(0)"
                          @click="switchRegisterForm"
                          style="color: #0f6cb2 !important"
                          >Đăng ký</a
                        >
                        tài khoản mới.
                      </p>
                      <p
                        class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                        v-if="is_user_inactive"
                      >
                        Số điện thoại đã bị khóa. Vui lòng nhập số điện thoại
                        khác
                      </p>
                    </div>
                    <div class="form-group" v-if="is_exist_phone">
                      ...
                      <input
                        ...
                        :class="[
                          'form-control',
                          !is_valid_password || !is_valid_password_length
                            ? 'form-control--error'
                            : '',
                        ]"
                      ...
                      <p
                        class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                        v-if="!is_valid_password"
                      >
                        Trường này là bắt buộc
                      </p>
                      <p
                        class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                        v-if="!is_valid_password_length"
                      >
                        Mật khẩu phải có ít nhất 6 ký tự
                      </p>
                      <p
                        class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                        v-if="!is_correct_phone_or_password"
                      >
                        Tên đăng nhập hoặc mật khẩu không đúng. Vui lòng thử
                        lại.
                      </p>
                      <p
                        class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
              ...
              >
                <div class="container" style="padding: 0px; width: 100%">
                  <div v-if="!isVerifySMSCodeSuccess">
                    <div
                      class="form-group d-inline-block col-md-12 no-padding text-left"
                    >
                      <input
                        type="text"
                        :class="[
                      ...
                      <p
                        class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                        v-if="is_sending_sms_failure"
                      >
                        Không gửi được mã xác nhận. Vui lòng kiểm tra lại số
                        điện thoại.
                      </p>
                    </div>
                    ...
                    <p
                      class="mt-2 mb-2 text-left text--error d-inline-block col-md-12 no-padding mb-0"
                      v-if="!is_valid_captcha"
                    >
                      Bạn chưa nhập mã captcha.
                    </p>
                    <button
                      v-if="isSendingVerifySMSCode"
                      @click="sendingSMS"
                    ...
                    <div
                      v-if="hasVerifySMSCode"
                      class="form-group d-inline-block col-md-12 no-padding text-left mt-3"
                    >
                      <input
                        type="text"
                        :class="[
                          'form-control',
                          !is_valid_sms_code || !is_correct_verify_sms_code
                            ? 'form-control--error'
                            : '',
                        ]"
                        placeholder="Nhập mã xác thực"
                        v-model="verify_sms_code"
                        :disabled="show_loading"
                      ...
                      <p
                        class="mt-1 text--error d-inline-block"
                        v-if="!is_valid_sms_code"
                      >
                        Trường này là bắt buộc
                      </p>
                      <p
                        class="mt-1 text--error d-inline-block"
                        v-if="!is_correct_verify_sms_code"
                      >
                  ...
                  <div v-else>
                    <div class="form-group text-left">
                      ...
                      <p
                        class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                        v-if="!is_valid_new_password"
                      >
                        Trường này là bắt buộc
                      </p>
                      <p
                        class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                        v-if="!is_valid_new_password_length"
                      >
                    ...
                    <div class="form-group text-left">
                      ...
                      <input
                        ...
                        :class="[
                          'form-control',
                          !is_valid_new_password2 ||
                          !is_valid_new_password2_length
                            ? 'form-control--error'
                            : '',
                        ]"
                        v-on:keydown.enter.prevent=""
                      ...
                      <p
                        class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                        v-if="!is_valid_new_password2"
                      >
                        Trường này là bắt buộc
                      </p>
                      <p
                        class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                        v-if="!is_valid_new_password2_incorrect"
                      >
            ...
            <div v-show="isRegister">
              ...
              >
                ...
                <div class="d-inline-block col-md-12 no-padding">
                  <div
                    :class="[
                      'form-group d-inline-block text-left float-left',
                      isVerifySMSCodeSuccess ? 'col-md-6' : 'col-md-12',
                    ]"
                  >
                    <div
                      class="form-group d-inline-block col-md-12 no-padding text-left"
                    >
                      ...
                      />
                      <p
                        v-if="isVerifySMSCodeSuccess"
                        class="mt-1 d-inline-block text-success text-left col-md-12 no-padding mt-0"
                      >
                        <i class="fas fa-check-circle"></i>&nbsp;Số điện thoại
                        đã được xác thực
                      </p>
                      <p
                        class="mt-1 text--error d-inline-block"
                    ...
                    <div v-if="isVerifySMSCodeSuccess">
                      ...
                      >
                        ...
                        <input
                          ...
                          :class="[
                            'form-control',
                            !is_valid_password2 || !is_valid_diff_password
                              ? 'form-control--error'
                              : '',
                          ]"
                          v-on:keydown.enter.prevent=""
                        ...
                        <p
                          class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                          v-if="!is_valid_password2"
                        >
                          Trường này là bắt buộc
                        </p>
                        <p
                          class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                          v-if="!is_valid_diff_password"
                        >
                          Mật khẩu nhập lại không khớp
                        </p>
                      </div>
                      ...
                      >
                        ...
                        <input
                          ...
                          :class="[
                            'form-control',
                            !is_valid_email || is_existed_email
                              ? 'form-control--error'
                              : '',
                          ]"
                          placeholder="Email"
                      ...
                      >
                        ...
                        <div
                          :class="[
                            'form-control',
                            !is_valid_gender ? 'form-control--error' : '',
                          ]"
                        >
                  ...
                  <div
                    v-if="isVerifySMSCodeSuccess"
                    class="form-group d-inline-block col-md-6 text-left float-left"
                  >
                    <div
                      class="form-group d-inline-block col-md-12 no-padding text-left"
                    >
                    ...
                    >
                      ...
                      <v-select
                        ...
                        :disabled="show_loading"
                        :class="[
                          !is_valid_district ? 'form-control--error' : '',
                        ]"
                        readonly
                      >
                      </v-select>
                    ...
                    >
                      ...
                      <v-select
                        ...
                        :disabled="show_loading"
                        :class="[
                          !is_valid_village ? 'form-control--error' : '',
                        ]"
                        readonly
                      >
                      </v-select>
                    ...
                    >
                      ...
                      <date-picker
                        ...
                        :class="[
                          'form-control',
                          !is_valid_birthday ? 'form-control--error' : '',
                        ]"
                        autocomplete="off"
                        readonly
                        :disabled="show_loading"
          ...
          <div class="modal-footer">
            <div class="col-md-12 float-left no-padding" v-if="show_btn_login">
              <div
                class="form-group col-md-6 float-right text-right no-padding"
              >
                <button
                  type="button"
                  class="btn btn-info btn-flat"
                  v-on:click="login()"
                  :disbaled="show_loading"
                >
                  <i
                    class="fa fa-spinner fa-spin"
                    style="font-size: 20px"
            ...
            <div
              class="form-group col-md-12 float-left"
              v-if="show_btn_register"
            >
            ...
            <div
              class="col-md-12 float-left no-padding"
              v-if="show_btn_change_pass"
            >
              <div class="col-md-6 float-left text-left mt-3 no-padding">
                <p>
                  Bạn đã có tài khoản?
  ...
  watch: {
    ...
    verify_email: function () {
      ...
      if (this.verify_email.length > 0) {
        this.is_valid_verify_email_format = this.email_reg.test(
          this.verify_email
        );
      }
    },
    ...
    new_password2: function () {
      ...
      if (this.new_password2.length > 0) {
        this.is_valid_new_password2_incorrect =
  ...
  methods: {
    recapchaVerifierChangePass: function () {
      ...
      window.recaptchaVerifier = new firebase.auth.RecaptchaVerifier(
        "recaptcha-container-changepass",
        {
          size: "normal",
    ...
    checkPhone: function () {
      ...
      this.show_loading = true;
      axios
        .get(url + "/api/check-exist-phone/" + this.phone)
        .then((response) => {
          this.show_loading = false;
          this.isChangedPasswordSuccess = false;
    ...
    checkEmail: function () {
      ...
      // this.show_loading = true;
      axios
        .get(url + "/api/check-exist-email/" + this.email)
        .then((response) => {
