<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <div>
        <div v-if="!isLogged" >
            <b-button @click="open_login_modal" v-bind:class="'btn-login'">
                <i class="fas fa-sign-in-alt"></i>&nbsp;Đăng nhập
            </b-button>
        </div>
        <div v-else class="customer-name show">
        ...
        <b-modal ref="my-modal" id="loginForm" no-close-on-esc no-close-on-backdrop centered no-stacking scrollable >
                                    ...
                                    <div class="form-group text-left">
                                        ...
                                        <p class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                                           v-if="is_valid_phone_not_exist">Số điện thoại không tồn tại. Bạn có thể
                                            <a href="javascript:void(0)" @click="switchRegisterForm" class="btn-login">Đăng ký</a> tài khoản mới.
                                        </p>
                                        <p class="mt-2 text--error d-inline-block col-md-12 no-padding mb-0"
                                           v-if="is_user_inactive">Số điện thoại đã bị khóa. Vui lòng nhập số điện thoại khác
                                        </p>
                                    </div>
                                    <div class="form-group text-left" v-if="is_exist_phone || isRegisterSuccess || isChangedPasswordSuccess">
                    ...
                    <div v-show="isRegister">
                        <div class="page-content" style="background: #fff;padding-bottom: 20px;">
                            <p class="text--error col-md-12" v-if="has_error_register">
                                Đã xảy ra lỗi. Vui lòng kiểm tra lại các thông tin của bạn và hãy chắc chắn rằng địa chỉ email là chính xác!
                            </p>
...
<!--                <div v-if="isVerifySMSCodeSuccess" class="col-md-12 d-inline-block no-padding">-->

<!--                    <div class="col-md-12 float-left no-padding" v-if="isSendEmailVerifyCode">-->
<!--                        <div class="col-md-6 float-left text-left mt-3 no-padding">-->
<!--                            <p>Bạn đã có tài khoản? <a href="javascript:void(0)" @click="switchLoginForm"-->
<!--                                                       style="color: #0f6cb2 !important">Đăng nhập ngay</a></p>-->
<!--                        </div>-->
<!--                        <div class="form-group col-md-6 float-right text-right no-padding">-->
<!--                            <button type="button" class="btn btn-info btn-flat" v-on:click="sendEmail" :disabled="show_loading">-->
<!--                                <i class="fa fa-spinner fa-spin" style="font-size:20px" v-if="show_loading"></i>&nbsp;Gửi yêu cầu-->
<!--                            </button>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                    <div class="col-md-12 float-left no-padding" v-if="isVerifyCode">-->
<!--                        <div class="col-md-6 float-left text-left mt-3 no-padding">-->
<!--                            <p>Bạn đã có tài khoản? <a href="javascript:void(0)" @click="switchLoginForm"-->
<!--                                                       style="color: #0f6cb2 !important">Đăng nhập ngay</a></p>-->
<!--                        </div>-->
<!--                        <div class="form-group col-md-6 float-right text-right no-padding">-->
<!--                            <button type="button" class="btn btn-info btn-flat" v-on:click="verifyCode" :disabled="show_loading">-->
<!--                                <i class="fa fa-spinner fa-spin" style="font-size:20px" v-if="show_loading"></i>&nbsp;Xác thực-->
<!--                            </button>-->
<!--                        </div>-->
<!--                    </div>-->
                    ...
                    <div class="col-md-12 no-padding" v-if="isLoginSuccess">
                        <div class="form-group col-md-6 float-right text-right no-padding">
                            <b-button class="mt-3" block v-on:click="$bvModal.hide('loginForm')">Đóng</b-button>
                        </div>
                    </div>
<!--                </div>-->
            </template>
        ...
        methods: {
            ...
            reCheckLogged: function() {
                ...
                $.each(this.$root.$children, function(k, v){
                    let id = this.$el.id;
                    if(id === 'form_reviews' || id === 'checkout_component') {
