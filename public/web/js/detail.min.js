  ...
  methods: {
    checkStatus: function checkStatus() {
      ...
      axios.get(url + '/api/status/' + this.product_id).then(function (response) {
        _this.status = response.data[0].status === 0;
      });
    }
  }
});
      ...
      _c("li", [
        _c("div", { staticClass: "row" }, [
          _c("div", {
            ...
            domProps: { innerHTML: _vm._s(_vm.attributes.short_description) }
          })
        ])
      ]),
      _vm._v(" "),
              ...
              _vm._l(_vm.attributes.colors, function(attr) {
                return _c("div", [
                  _c("input", {
                    ...
                    attrs: { type: "radio", id: attr.color, name: "color" },
                    domProps: {
                      value: attr.color,
                  ...
                  _c("label", { attrs: { for: attr.color } }, [
                    _c("span", { style: _vm._f("format_color")(attr.color) })
                  ])
                ])
              }),
              0
                    ...
                    return _c("div", { staticClass: "product" }, [
                      _c("div", { staticClass: "product-micro" }, [
                        _c("div", { staticClass: "row product-micro-row" }, [
                          _c("div", { staticClass: "col col-xs-5" }, [
                          ...
                          _vm._v(" "),
                          _c("div", { staticClass: "col col-xs-7" }, [
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("span", { class: _vm.status ? "text-success" : "text-danger" }, [
    _vm._v(_vm._s(_vm.status ? "Còn hàng" : "Hết hàng"))
  ])
}
var staticRenderFns = []
render._withStripped = true
